...
serve(async (req) => {
  ...
  try {
    ...
    const prompt = `
      ...
      Basado en el nivel, asignatura y tema proporcionados, genera una lista detallada de contenidos y temas a abordar en una unidad de planificación.
      La respuesta debe ser un único string de texto, con los temas separados por saltos de línea (usando '- ' para cada ítem). No incluyas títulos ni introducciones, solo la lista.
    ...
    console.error("Error in suggest-unit-content:", error);
