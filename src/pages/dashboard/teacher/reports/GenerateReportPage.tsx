...
import { fetchCursosAsignaturasDocente, fetchEstudiantesPorCurso, fetchCursosPorEstablecimiento, Estudiante, CursoBase } from '@/api/courses';
import { checkReportEligibility, generateReport, saveReport } from '@/api/reports';
