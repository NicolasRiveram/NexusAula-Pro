...
const SchedulePage = lazy(() => import("../pages/dashboard/teacher/schedule/SchedulePage"));
const DidacticPlannerPage = lazy(() => import("../pages/dashboard/teacher/planning/DidacticPlannerPage"));
const NewUnitPlan = lazy(() => import("../pages/dashboard/teacher/planning/NewUnitPlan"));
const EditUnitPlanPage = lazy(() => import("../pages/dashboard/teacher/planning/EditUnitPlanPage"));
const UnitPlanDetailPage = lazy(() => import("../pages/dashboard/teacher/planning/UnitPlanDetailPage"));
...
const CourseDetailPage = lazy(() => import("../pages/dashboard/courses/CourseDetailPage"));
const StudentDetailPage = lazy(() => import("../pages/dashboard/teacher/student-detail/TeacherStudentDetailPage"));
const ProfileSetup = lazy(() => import("../pages/ProfileSetup"));
const NotFound = lazy(() => import("../pages/NotFound"));
const BitacoraPage = lazy(() => import("../pages/dashboard/teacher/bitacora/BitacoraPage"));
const RubricsPage = lazy(() => import("../pages/dashboard/teacher/rubrics/RubricsPage"));
const RubricBuilderPage = lazy(() => import("../pages/dashboard/teacher/rubrics/RubricBuilderPage"));
const EditRubricPage = lazy(() => import("../pages/dashboard/teacher/rubrics/EditRubricPage"));
const RubricDetailPage = lazy(() => import("../pages/dashboard/teacher/rubrics/RubricDetailPage"));
const EvaluateRubricPage = lazy(() => import("../pages/dashboard/teacher/rubrics/EvaluateRubricPage"));
const AnalyticsPage = lazy(() => import("../pages/dashboard/teacher/analytics/AnalyticsPage"));
...
const ReportsPage = lazy(() => import("../pages/dashboard/teacher/reports/ReportsPage"));
const GenerateReportPage = lazy(() => import("../pages/dashboard/teacher/reports/GenerateReportPage"));
const ViewReportPage = lazy(() => import("../pages/dashboard/teacher/reports/ViewReportPage"));
