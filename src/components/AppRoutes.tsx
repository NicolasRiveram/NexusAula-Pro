...
const SchedulePage = lazy(() => import("../pages/dashboard/teacher/SchedulePage"));
...
const StudentDetailPage = lazy(() => import("../pages/dashboard/teacher/StudentDetailPage"));
const ProfileSetup = lazy(() => import("../pages/ProfileSetup"));
const NotFound = lazy(() => import("../pages/NotFound"));
const BitacoraPage = lazy(() => import("../pages/dashboard/teacher/BitacoraPage"));
...
const AnalyticsPage = lazy(() => import("../pages/dashboard/teacher/AnalyticsPage"));
